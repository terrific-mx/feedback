...
$classes = Flux::classes()
    ...
    ->add(match ($variant) {
        default => [ // Adjust spacing around label...
            '*:data-flux-label:mb-1.5 [&>[data-flux-label]:has(+[data-flux-description])]:mb-0',
        ],
        'inline' => '',
    })
    ->add(match ($variant) {
        default => [ // Adjust spacing around description...
            ...
            '[&>[data-flux-label]+[data-flux-description]]:mb-1.5',
            '[&>*:not([data-flux-label])+[data-flux-description]]:mt-1.5',
        ],
        'inline' => '',
    });
@endphp
